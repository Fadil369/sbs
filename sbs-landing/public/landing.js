        ...
        <div class="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div class="relative w-full max-w-md bg-slate-900 rounded-2xl shadow-2xl overflow-hidden z-10 border border-emerald-500/50 p-8 text-center">
            ...
            <div class="flex gap-3 justify-center">
              ...
              ${this.currentClaimId ? `
                <button onclick="app.openTrackingModal('${this.currentClaimId}')" class="px-6 py-2 bg-emerald-500 hover:bg-emerald-400 text-slate-900 rounded-lg font-bold transition-all flex items-center gap-2">
